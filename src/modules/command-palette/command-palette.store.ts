...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/aashieshsingh/alletool',
      category: 'External',
      description: 'View the source code of Alletool on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve Alletool.',
      href: 'https://github.com/aashieshsingh/alletool',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about Alletool.',
      to: '/about',
      category: 'Pages',
